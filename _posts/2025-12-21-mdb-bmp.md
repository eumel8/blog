...
Interessant in dem Zusammenhang: Es gibt viele nützliche Tools unter Linux, deren Funktion man sich unter Windows oder im Web teuer mit Programmlizenzen erkaufen müsste. 

Mit `ffmpeg` kann man beliebige Medienformate umwandeln, avi in mp4, mkv in mp4, mehrere Dateien zusammenführen - alles kein Problem.

```
ffmpeg -i VTS_01_1.avi -i VTS_01_2.avi -filter_complex [0:v][0:a][1:v][1:a]concat=n=2:v=1:a=1[outv][outa] -map [outv] -map [outa] -c:v libx264 -crf 23 -preset fast -c:a aac -b:a 192k -ac 2 1.mp4
```

Ein anderes Tool ist `eyeD3`. Damit kann man die Metadaten eines MP3 auslesen:

```
# eyeD3 01\ -\ Calling\ Elvis\ -\ Dire\ Straits.mp3
/mnt/mycloud/Media/Musik/Archive/0001/01 - Calling Elvis - Dire Straits.mp3                                                        [ 11.83 MB ]
------------------------------------------------------------------------------------------------------------------------------------------------
Time: 09:19     MPEG1, Layer III        [ ~177 kb/s @ 44100 Hz - Joint stereo ]
------------------------------------------------------------------------------------------------------------------------------------------------
ID3 v2.3:
title: Calling Elvis
artist: Dire Straits
album: Strait To The Point  - CD1 (Live Bootleg)
recording date: 1991
track: 1/8              genre: Rock (id 17)
```

Mit einem Script kann man diese Daten dann weiterverwerten wie etwa in unserer MDB.
