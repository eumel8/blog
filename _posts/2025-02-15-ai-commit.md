...
Neben der teuren Variante mit OpenAI gibt es jetzt auch [opencode](https://opencode.ai) mit verschiedenen LLM-Providern. Wir haben dazu schon im K8s Blog einen Artikel geschrieben. Das Tool lässt sich auch hervorragend für [commit message Generierung](https://github.com/eumel8/ai-commit?tab=readme-ov-file#opencode-2026)  verwenden.  Der Vorteil: man kann verschiedene LLM-Provider verwenden und hat nur diese eine Schnittstelle.
